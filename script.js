...
acts104448.addEventListener('click', () => {
    verse.innerHTML = "44 While Peter was still speaking these words, the Holy Spirit came on all who heard the message.<br><br>" +
        ...
        "46 For they heard them speaking in tongues[b] and praising God. Then Peter said,<br><br>" +
...
galatians32329.addEventListener('click', () => {
    verse.innerHTML = "23 Before the coming of this faith,[j] we were held in custody under the law, locked up until the faith that was to come would be revealed.<br><br> " +
